  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'teal-gradient': 'linear-gradient(135deg, #0a2828 0%, #0d2525 25%, #0f1f1f 50%, #0a1a1f 75%, #08141a 100%)',
        'teal-radial': 'radial-gradient(circle at 20% 30%, rgba(25,155,155,0.15), transparent 50%)',
        'cyan-glow': 'radial-gradient(circle at 80% 20%, rgba(6,182,212,0.12), transparent 40%)',
      }
    },
  },
  plugins: [],
